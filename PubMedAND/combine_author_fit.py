...
allfiles = os.listdir('Similarity_profile_new')
print("Printing all files in the above directory\n",allfiles,"\n")

target_filename = "Fit_dataset.xlsx"
author=0
wb1 = Workbook()
#add header
ws1 = wb1.active
...
for author in range(0,len(allfiles)):
    wbauthor = load_workbook("Similarity_profile_new/"+allfiles[author])
...
data_xls.to_csv('Fit_dataset.csv', encoding='utf-8', index=False)